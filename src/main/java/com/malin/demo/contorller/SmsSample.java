...
public class SmsSample {
	...
	public static void main(String[] args) {
		...
		String testUsername = "zsls"; //在短信宝注册的用户名
		String testPassword = "123456"; //在短信宝注册的密码
		String testPhone = "15243698125";
		String testContent = "【蚂蚁课堂-】您的验证码是12345,５分钟内有效。若非本人操作请忽略此消息。"; // 注意测试时，也请带上公司简称或网站签名，发送正规内容短信。千万不要发送无意义的内容：例如 测一下、您好。否则可能会收不到
		...
		String httpArgs = httpArgs(testUsername, testPassword, testPhone, testContent);
		System.out.println("-------"+httpArgs);
